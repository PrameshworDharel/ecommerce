  ...
  return (
    <>
      <div>
        ...
        <div className="bg-seventh flex justify-between p-5 font-semibold">
          ...
          <div className="flex mr-16 gap-6">
            ...
            <button className=" border text-fourth bg-primary  border-primary px-3 py-2">
              16
            </button>
            <h3 className="mt-3">Short by</h3>
            <button className="border text-fourth bg-primary  border-primary px-8 py-4 ">
              Default
            </button>
          </div>
        </div>
      ...
      <div className="flex justify-center gap-6 mb-12">
        ...
        <button className="border bg-fifth border-fifth px-4 py-2 b-16">
          Next
        </button>
      </div>
      <div className="bg-Tertiary flex justify-between p-16">
        ...
        <div>
          ...
          <p className="text-fourth">
            <small>
              If goods have problems, consectetur <br></br> adipim scing elit.
            </small>
          </p>
        </div>
        <div>
          ...
          <p className="text-fourth">
            <small>
              100% secure payment, consectetur <br></br> adipim scing elit.
            </small>
          </p>
        </div>
      </div>
